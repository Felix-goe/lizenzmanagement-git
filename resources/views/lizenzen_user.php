        ...
        <div class="main">
            ...
            <main class="content px-3 py-4">
                <div class="container-fluid">
                    <div class="mb-3">
                        <h3 class="fw-bold fs-4 mb-3">Lizenverwaltung</h3>
                                    ...
                                    <div class="modal-body" style="align-items: center;">
                                        ...
                                        <div class="form-group" style="margin-top: 5px;">
                                            ...
                                            style="display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 10px; height: 300px; text-align: center;">
                                                ...
                                                <i class="fa-solid fa-upload" style="color: #0298cf; font-size: 200%; margin-bottom: 5px;"></i>
                                                

                                                <p class="small my-2" style="margin: 0;">Bild der Rechnung hier hineinziehen
                                                    <br><i>oder</i>
                                                </p>
                                                ...
                                                <label class="btn btn-upload mb-3 blue-btn" for="upload_image_background">Datei
                                                    auswählen</label>
